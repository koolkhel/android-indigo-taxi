...
//#define SERVER_ADDRESS "192.168.17.24"
...
void Backend::setTaxiId(int _taxiId) {
    taxiId = _taxiId;

    // обновить тарифы и т.д.
    sendEvent(hello_TaxiEvent_GET_INFO);

    emit taxiOrgChanged(taxiId);
}
